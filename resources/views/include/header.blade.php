<nav class="navbar navbar-expand-lg navbar-dark py-3 px-md-4" style="background: linear-gradient(135deg,#b5d1fa,#e7effa);">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold fs-4 tracking-tight" href="#">SORA Jewelry</a>
